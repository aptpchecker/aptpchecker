...
class GlobalSettings:
    ...
    def __init__(self):
        ...
        self.mip_tightening_timeout_per_neuron = 10.0
        self.mip_tightening_topk = 64
        self.disable_refine_conv = False
        
        # gpu stabilize
        self.use_gpu_tightening = 0
        self.gpu_tightening_current_hidden_branches = 500000
        self.gpu_tightening_visited_hidden_branches = 5000000
    ...
    def setup(self, args):
        ...
        self.use_restart = 0
        self.use_mip_tightening = bool(int(os.getenv("NeuralSAT_S", 0)))
